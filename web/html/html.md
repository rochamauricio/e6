...
# Imagens:
> title=atributo que mostra texto quando mouseOver, Ao modificar apenas width ou apenas height ele não distorce a
imagem. -->
~~~html
...
# Object:
> Insere objetos como imagens e arquivos pdf, Use this element to embed multimedia (audio, video, ActiveX, PDF
Flash) in your pages. -->
~~~html
...
# Tags semânticas:
~~~html
<!-- Tags responsáveis pelo cabeçalho -->
<header> 

<!-- Tags responsáveis pela navegação -->
<nav>
